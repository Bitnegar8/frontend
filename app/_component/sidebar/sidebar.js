      ...
      <div className={"px-6 pb-4  "}>
        ...
        <div className={"flex items-center py-3"}>
          <span className={"pr-3 flex items-center"}>
            ...
            <Link href={"/dashboard/Action"} className={"flex items-center justify-between w-full"} onClick={() => handleCompanyTab(!companyTab)}>
                <div className={"flex items-center justify-between w-full"}>
                    <div className={"flex items-center"}>
        ...
        <div className={"flex items-center py-3"}>
          ...
          <div className={"text-gray-400 flex items-center mt-[3px]"}>Transaction</div>
        </div>
      </div>
