...
const OffTable = () => {
  ...
  return (
    <>
      <div className="relative w-full  bg-white rounded-lg  flex flex-col items-start w-full h-[85vh] !mt-5 overflow-auto ">
        <table className="text-sm text-gray-500 w-full">
          <thead className="text-xs text-gray-700 uppercase ">
            <tr className={"border-b border-gray-400"}>
              <th
                scope="col"
                className="px-6 py-3 !text-center  w-4 font-normal text-gray-600 text-sm"
              >
              ...
              <th
                ...
                className="px-6 py-3 !text-center  w-4 font-normal text-gray-600 text-sm"
              >
                <div className={"mt-1"}>{"DEVELOPER NAME"}</div>
              </th>
              ...
              <th
                ...
                className="px-6 py-3 !text-center  w-4 font-normal text-gray-600 text-sm"
              >
                <div className={"mt-1"}>{"UNIT TYPE"}</div>
              </th>
              <th
                scope="col"
                className="px-6 py-3 !text-center  w-4 font-normal text-gray-600 text-sm"
              >
                <div className={"mt-1"}>{"AMENITIES"}</div>
              </th>
              <th
                scope="col"
                className="px-6 py-3 !text-center  w-4 font-normal text-gray-600 text-sm"
              >
                <div className={"mt-1"}>{"AREA SIZE"}</div>
              </th>
              <th
                scope="col"
                className="px-6 py-3 !text-center  w-4 font-normal text-gray-600 text-sm"
              >
                <div className={"mt-1"}>{"MAP LOCATION"}</div>
              </th>
              ...
              <th
                ...
                className="px-6 py-3 !text-center  w-4 font-normal text-gray-600 text-sm"
              >
                <div className={"mt-1"}>{"PAYMENT PLAN"}</div>
              </th>
              ...
              <th
                ...
                className="px-6 py-3 !text-center  w-4 font-normal text-gray-600 text-sm"
              >
                <div className={"mt-1"}>{"VIEW TYPE"}</div>
              </th>
              ...
              <th
                ...
                className="px-6 py-3 !text-center  w-4 font-normal text-gray-600 text-sm"
              >
                <div className={"mt-1"}>{"HAND OVER TIME"}</div>
              </th>
            </tr>
          </thead>
          <tbody>
            {CONST.oFFmodal?.map(
              (item, index) =>
                (filterSearch?.includes(index) ||
                  (filterSearch.length === 0 && !changeFilter)) && (
