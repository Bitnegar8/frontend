...
function MyMap({location}) {
    ...
    // Define your marker locations
    const predefinedMarkers = [
        { longitude: 55.2744, latitude: 25.1972 }, // Example location 1
        { longitude: 55.2750, latitude: 25.1980 }, // Example location 2
        { longitude: 55.2730, latitude: 25.1960 }, // Example location 3
    ];
